...
if (!allcourses || !courseData) {
  ...
  if (allcourses && !courseData) return <p>Course not found.</p>;
  ...
  return (
    <>
    <div  className="relative min-h-screen py-12 px-6 md:px-36 bg-gradient-to-b from-cyan-100 to-white text-gray-800 flex gap-10">
      <div className="absolute top-0 left-0 w-full h-72 md:h-96 -z-10 bg-gradient-to-b from-cyan-100/70 to-transparent"></div>

      {/* Left column */}
      <div className='max-w-xl z-10'>
        <h1 className="text-4xl font-semibold mb-4">{courseData.courseTitle}</h1>
      ...
      {/* Right column */}
      <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[3px] sm:min-w-[420px]">
        ...
        <div className='p-5'>
          ...
          <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
            ...
            <div className='flex items-center gap-1'>
              ...
              <p>{calculateTotalDuration(courseData)}</p>
            </div>
          ...
          <button onClick={enrollCourse} className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium">
            ...
            <div className='pt-6'>
              <p className='md:text-xl text-lg font-medium text-gray-800'>Course Highlight</p>
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                 <li>Unlimited access with regular updates.</li>
