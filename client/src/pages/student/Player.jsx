...
//This funtion i have added  at last when i was not able to watch the video. it was simply disappearing on clicking
function extractYouTubeId(url) {
  if (!url || typeof url !== 'string') return null;

  // matches v=ID (and stops at &), youtu.be/ID, and embed/ID
    ...
    <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
        ...
        <div className='text-gray-800'>
          ...
          <div className='pt-5 max-w-xl'>
                   ...
                   <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                    {chapter.chapterContent.map((lecture,i)=>(
                      <li key = {i} className='flex items-start gap-2 py-1'>
                        ...
                        lectureCompleted.includes(lecture.lectureId) ? assets.blue_tick_icon : assets.play_icon} alt="play icon" className='w-4 h-4 mt-1' />
            ...
            <div className='flex items-center gap-2 py-3 mt-10'>
              <h1 className='text-xl font-bold'>How would you rate this course?</h1>
        ...
        <div className='md:mt-10'>
          ...
          <img  src={courseData ? courseData.courseThumbnail : ''} alt="" />
             ...
             {playerData ? (
                 <div>
                   {extractYouTubeId(playerData.lectureUrl) ? (
                     <YouTube
