...
const handleSubmit = async (e)=> {
  ...
  useEffect(() => {
    //inintializing  quill only once here
      ...
      <div className='flex flex-col gap-1 relative'>
         ...
         <div className="relative">
           <input 
             ...
             min={0} 
             max={100} 
             className='outline-none md:py-2.5 py-2 w-28 px-3 pr-8 rounded border border-gray-500 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all duration-200' 
             required 
           />
